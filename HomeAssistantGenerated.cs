...
namespace HomeAssistantGenerated
{
	...
	public partial class AutomationEntities
	{
		...
		public AutomationEntity NotifyAndRemoveCompletedTorrent => new(_haContext, "automation.notify_and_remove_completed_torrent");
	...
	public partial class InputBooleanEntities
	{
		...
		public InputBooleanEntity DevNetdaemonTibberTibberNotification => new(_haContext, "input_boolean.dev_netdaemon_tibber_tibber_notification");
	...
	public partial class SensorEntities
	{
		...
		public NumericSensorEntity ElectricityPriceBlodrotsvagen1 => new(_haContext, "sensor.electricity_price_blodrotsvagen_1");
		...
		public NumericSensorEntity MinecraftServerPlayersOnline => new(_haContext, "sensor.minecraft_server_players_online");
		...
		public NumericSensorEntity MonthlyNetConsumptionBlodrotsvagen1 => new(_haContext, "sensor.monthly_net_consumption_blodrotsvagen_1");
		///<summary>Monthly peak hour consumption Blodrotsvägen 1</summary>
		public NumericSensorEntity MonthlyPeakHourConsumptionBlodrotsvagen1 => new(_haContext, "sensor.monthly_peak_hour_consumption_blodrotsvagen_1");
		...
		public SensorEntity TimeOfMaxHourConsumptionBlodrotsvagen1 => new(_haContext, "sensor.time_of_max_hour_consumption_blodrotsvagen_1");
	...
	public class NotifyServices
	{
		...
		{
			_haContext.CallService("notify", "mobile_app_dn2103", null, data);
		}
		...
		{
			_haContext.CallService("notify", "mobile_app_dn2103", null, new NotifyMobileAppDn2103Parameters{Message = @message, Title = @title, Target = @target, Data = @data});
		}
		...
		{
			_haContext.CallService("notify", "mobile_app_le2123", null, data);
		}
		...
		{
			_haContext.CallService("notify", "mobile_app_le2123", null, new NotifyMobileAppLe2123Parameters{Message = @message, Title = @title, Target = @target, Data = @data});
		}
	...
	public class PythonScriptServices
	{
		...
		{
			_haContext.CallService("python_script", "hello_world", null);
		}

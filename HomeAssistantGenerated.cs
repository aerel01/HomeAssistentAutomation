...
public class Entities : IEntities {
  ...
  public Entities(IHaContext haContext) => _haContext = haContext;
...
public class AutomationEntities {
  ...
  public AutomationEntities(IHaContext haContext) => _haContext = haContext;
...
public class BinarySensorEntities {
  ...
  public BinarySensorEntities(IHaContext haContext) => _haContext = haContext;
...
public class ButtonEntities {
  ...
  public ButtonEntities(IHaContext haContext) => _haContext = haContext;
...
public class CoverEntities {
  ...
  public CoverEntities(IHaContext haContext) => _haContext = haContext;
...
public class DeviceTrackerEntities {
  ...
  public DeviceTrackerEntities(IHaContext haContext) => _haContext = haContext;
...
public class InputBooleanEntities {
  ...
  public InputBooleanEntities(IHaContext haContext) => _haContext = haContext;
...
public class InputNumberEntities {
  ...
  public InputNumberEntities(IHaContext haContext) => _haContext = haContext;
...
public class LightEntities {
  ...
  public LightEntities(IHaContext haContext) => _haContext = haContext;
...
public class NumberEntities {
  ...
  public NumberEntities(IHaContext haContext) => _haContext = haContext;
...
public class PersistentNotificationEntities {
  ...
  public PersistentNotificationEntities(IHaContext haContext) => _haContext = haContext;
...
public class PersonEntities {
  ...
  public PersonEntities(IHaContext haContext) => _haContext = haContext;
...
public class SceneEntities {
  ...
  public SceneEntities(IHaContext haContext) => _haContext = haContext;
...
public class SensorEntities {
  ...
  public SensorEntities(IHaContext haContext) => _haContext = haContext;
...
public class SunEntities {
  ...
  public SunEntities(IHaContext haContext) => _haContext = haContext;
...
public class SwitchEntities {
  ...
  public SwitchEntities(IHaContext haContext) => _haContext = haContext;
...
public class UpdateEntities {
  ...
  public UpdateEntities(IHaContext haContext) => _haContext = haContext;
...
public class WeatherEntities {
  ...
  public WeatherEntities(IHaContext haContext) => _haContext = haContext;
...
public class ZoneEntities {
  ...
  public ZoneEntities(IHaContext haContext) => _haContext = haContext;
...
public class Services : IServices {
  ...
  public Services(IHaContext haContext) => _haContext = haContext;
...
public class AlarmControlPanelServices {
  ...
  public AlarmControlPanelServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Send the alarm the command for arm away.</summary>
  ///<param name="target">The target for this service call</param>
  public void AlarmArmAway(ServiceTarget target, AlarmControlPanelAlarmArmAwayParameters data) => _haContext.CallService("alarm_control_panel", "alarm_arm_away", target, data);

  ///<summary>Send the alarm the command for arm away.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="code">An optional code to arm away the alarm control panel with. eg: 1234</param>
  public void AlarmArmAway(ServiceTarget target, string? code = null) => _haContext.CallService("alarm_control_panel", "alarm_arm_away", target,
        new AlarmControlPanelAlarmArmAwayParameters { Code = code });

  ///<summary>Send arm custom bypass command.</summary>
  ///<param name="target">The target for this service call</param>
  public void AlarmArmCustomBypass(ServiceTarget target, AlarmControlPanelAlarmArmCustomBypassParameters data) => _haContext.CallService("alarm_control_panel", "alarm_arm_custom_bypass", target, data);

  ///<summary>Send arm custom bypass command.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="code">An optional code to arm custom bypass the alarm control panel with. eg: 1234</param>
  public void AlarmArmCustomBypass(ServiceTarget target, string? code = null) => _haContext.CallService("alarm_control_panel", "alarm_arm_custom_bypass", target,
        new AlarmControlPanelAlarmArmCustomBypassParameters { Code = code });

  ///<summary>Send the alarm the command for arm home.</summary>
  ///<param name="target">The target for this service call</param>
  public void AlarmArmHome(ServiceTarget target, AlarmControlPanelAlarmArmHomeParameters data) => _haContext.CallService("alarm_control_panel", "alarm_arm_home", target, data);

  ///<summary>Send the alarm the command for arm home.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="code">An optional code to arm home the alarm control panel with. eg: 1234</param>
  public void AlarmArmHome(ServiceTarget target, string? code = null) => _haContext.CallService("alarm_control_panel", "alarm_arm_home", target,
        new AlarmControlPanelAlarmArmHomeParameters { Code = code });

  ///<summary>Send the alarm the command for arm night.</summary>
  ///<param name="target">The target for this service call</param>
  public void AlarmArmNight(ServiceTarget target, AlarmControlPanelAlarmArmNightParameters data) => _haContext.CallService("alarm_control_panel", "alarm_arm_night", target, data);

  ///<summary>Send the alarm the command for arm night.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="code">An optional code to arm night the alarm control panel with. eg: 1234</param>
  public void AlarmArmNight(ServiceTarget target, string? code = null) => _haContext.CallService("alarm_control_panel", "alarm_arm_night", target,
        new AlarmControlPanelAlarmArmNightParameters { Code = code });

  ///<summary>Send the alarm the command for arm vacation.</summary>
  ///<param name="target">The target for this service call</param>
  public void AlarmArmVacation(ServiceTarget target, AlarmControlPanelAlarmArmVacationParameters data) => _haContext.CallService("alarm_control_panel", "alarm_arm_vacation", target, data);

  ///<summary>Send the alarm the command for arm vacation.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="code">An optional code to arm vacation the alarm control panel with. eg: 1234</param>
  public void AlarmArmVacation(ServiceTarget target, string? code = null) => _haContext.CallService("alarm_control_panel", "alarm_arm_vacation", target,
        new AlarmControlPanelAlarmArmVacationParameters { Code = code });

  ///<summary>Send the alarm the command for disarm.</summary>
  ///<param name="target">The target for this service call</param>
  public void AlarmDisarm(ServiceTarget target, AlarmControlPanelAlarmDisarmParameters data) => _haContext.CallService("alarm_control_panel", "alarm_disarm", target, data);

  ///<summary>Send the alarm the command for disarm.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="code">An optional code to disarm the alarm control panel with. eg: 1234</param>
  public void AlarmDisarm(ServiceTarget target, string? code = null) => _haContext.CallService("alarm_control_panel", "alarm_disarm", target,
        new AlarmControlPanelAlarmDisarmParameters { Code = code });

  ///<summary>Send the alarm the command for trigger.</summary>
  ///<param name="target">The target for this service call</param>
  public void AlarmTrigger(ServiceTarget target, AlarmControlPanelAlarmTriggerParameters data) => _haContext.CallService("alarm_control_panel", "alarm_trigger", target, data);

  ///<summary>Send the alarm the command for trigger.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="code">An optional code to trigger the alarm control panel with. eg: 1234</param>
  public void AlarmTrigger(ServiceTarget target, string? code = null) => _haContext.CallService("alarm_control_panel", "alarm_trigger", target,
...
public class AutomationServices {
  ...
  public AutomationServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Reload the automation configuration.</summary>
  public void Reload() => _haContext.CallService("automation", "reload");

  ///<summary>Toggle (enable / disable) an automation.</summary>
  ///<param name="target">The target for this service call</param>
  public void Toggle(ServiceTarget target) => _haContext.CallService("automation", "toggle", target);

  ///<summary>Trigger the actions of an automation.</summary>
  ///<param name="target">The target for this service call</param>
  public void Trigger(ServiceTarget target, AutomationTriggerParameters data) => _haContext.CallService("automation", "trigger", target, data);

  ///<summary>Trigger the actions of an automation.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="skipCondition">Whether or not the conditions will be skipped.</param>
  public void Trigger(ServiceTarget target, bool? skipCondition = null) => _haContext.CallService("automation", "trigger", target,
        new AutomationTriggerParameters { SkipCondition = skipCondition });

  ///<summary>Disable an automation.</summary>
  ///<param name="target">The target for this service call</param>
  public void TurnOff(ServiceTarget target, AutomationTurnOffParameters data) => _haContext.CallService("automation", "turn_off", target, data);

  ///<summary>Disable an automation.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="stopActions">Stop currently running actions.</param>
  public void TurnOff(ServiceTarget target, bool? stopActions = null) => _haContext.CallService("automation", "turn_off", target,
        new AutomationTurnOffParameters { StopActions = stopActions });

  ///<summary>Enable an automation.</summary>
  ///<param name="target">The target for this service call</param>
  public void TurnOn(ServiceTarget target) => _haContext.CallService("automation", "turn_on", target);
}
...
public class ButtonServices {
  ...
  public ButtonServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Press the button entity.</summary>
  ///<param name="target">The target for this service call</param>
  public void Press(ServiceTarget target) => _haContext.CallService("button", "press", target);
}

public class ClimateServices {
  private readonly IHaContext _haContext;

  public ClimateServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Turn auxiliary heater on/off for climate device.</summary>
  ///<param name="target">The target for this service call</param>
  public void SetAuxHeat(ServiceTarget target, ClimateSetAuxHeatParameters data) => _haContext.CallService("climate", "set_aux_heat", target, data);

  ///<summary>Turn auxiliary heater on/off for climate device.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="auxHeat">New value of auxiliary heater.</param>
  public void SetAuxHeat(ServiceTarget target, bool auxHeat) => _haContext.CallService("climate", "set_aux_heat", target, new ClimateSetAuxHeatParameters { AuxHeat = auxHeat });

  ///<summary>Set fan operation for climate device.</summary>
  ///<param name="target">The target for this service call</param>
  public void SetFanMode(ServiceTarget target, ClimateSetFanModeParameters data) => _haContext.CallService("climate", "set_fan_mode", target, data);

  ///<summary>Set fan operation for climate device.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="fanMode">New value of fan mode. eg: low</param>
  public void SetFanMode(ServiceTarget target, string fanMode) => _haContext.CallService("climate", "set_fan_mode", target, new ClimateSetFanModeParameters { FanMode = fanMode });

  ///<summary>Set target humidity of climate device.</summary>
  ///<param name="target">The target for this service call</param>
  public void SetHumidity(ServiceTarget target, ClimateSetHumidityParameters data) => _haContext.CallService("climate", "set_humidity", target, data);

  ///<summary>Set target humidity of climate device.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="humidity">New target humidity for climate device.</param>
  public void SetHumidity(ServiceTarget target, long humidity) => _haContext.CallService("climate", "set_humidity", target,
        new ClimateSetHumidityParameters { Humidity = humidity });

  ///<summary>Set HVAC operation mode for climate device.</summary>
  ///<param name="target">The target for this service call</param>
  public void SetHvacMode(ServiceTarget target, ClimateSetHvacModeParameters data) => _haContext.CallService("climate", "set_hvac_mode", target, data);

  ///<summary>Set HVAC operation mode for climate device.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="hvacMode">New value of operation mode.</param>
  public void SetHvacMode(ServiceTarget target, object? hvacMode = null) => _haContext.CallService("climate", "set_hvac_mode", target,
        new ClimateSetHvacModeParameters { HvacMode = hvacMode });

  ///<summary>Set preset mode for climate device.</summary>
  ///<param name="target">The target for this service call</param>
  public void SetPresetMode(ServiceTarget target, ClimateSetPresetModeParameters data) => _haContext.CallService("climate", "set_preset_mode", target, data);

  ///<summary>Set preset mode for climate device.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="presetMode">New value of preset mode. eg: away</param>
  public void SetPresetMode(ServiceTarget target, string presetMode) => _haContext.CallService("climate", "set_preset_mode", target,
        new ClimateSetPresetModeParameters { PresetMode = presetMode });

  ///<summary>Set swing operation for climate device.</summary>
  ///<param name="target">The target for this service call</param>
  public void SetSwingMode(ServiceTarget target, ClimateSetSwingModeParameters data) => _haContext.CallService("climate", "set_swing_mode", target, data);

  ///<summary>Set swing operation for climate device.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="swingMode">New value of swing mode. eg: horizontal</param>
  public void SetSwingMode(ServiceTarget target, string swingMode) => _haContext.CallService("climate", "set_swing_mode", target,
        new ClimateSetSwingModeParameters { SwingMode = swingMode });

  ///<summary>Set target temperature of climate device.</summary>
  ///<param name="target">The target for this service call</param>
  public void SetTemperature(ServiceTarget target, ClimateSetTemperatureParameters data) => _haContext.CallService("climate", "set_temperature", target, data);
  ...
  public void SetTemperature(
      ...
      object? hvacMode = null) => _haContext.CallService("climate", "set_temperature", target,
  ...
  ///<param name="target">The target for this service call</param>
  public void TurnOff(ServiceTarget target) => _haContext.CallService("climate", "turn_off", target);

  ///<summary>Turn climate device on.</summary>
  ///<param name="target">The target for this service call</param>
  public void TurnOn(ServiceTarget target) => _haContext.CallService("climate", "turn_on", target);
}
...
public class CloudServices {
  ...
  public CloudServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Make instance UI available outside over NabuCasa cloud</summary>
  public void RemoteConnect() => _haContext.CallService("cloud", "remote_connect");

  ///<summary>Disconnect UI from NabuCasa cloud</summary>
  public void RemoteDisconnect() => _haContext.CallService("cloud", "remote_disconnect");
}

public class CounterServices {
  private readonly IHaContext _haContext;

  public CounterServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Change counter parameters.</summary>
  ///<param name="target">The target for this service call</param>
  public void Configure(ServiceTarget target, CounterConfigureParameters data) => _haContext.CallService("counter", "configure", target, data);
  ...
  public void Configure(
      ...
      long? step = null,
      long? initial = null,
      long? value = null) => _haContext.CallService("counter", "configure", target,
  ...
  ///<param name="target">The target for this service call</param>
  public void Decrement(ServiceTarget target) => _haContext.CallService("counter", "decrement", target);

  ///<summary>Increment a counter.</summary>
  ///<param name="target">The target for this service call</param>
  public void Increment(ServiceTarget target) => _haContext.CallService("counter", "increment", target);

  ///<summary>Reset a counter.</summary>
  ///<param name="target">The target for this service call</param>
  public void Reset(ServiceTarget target) => _haContext.CallService("counter", "reset", target);
}
...
public class CoverServices {
  ...
  public CoverServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Close all or specified cover.</summary>
  ///<param name="target">The target for this service call</param>
  public void CloseCover(ServiceTarget target) => _haContext.CallService("cover", "close_cover", target);

  ///<summary>Close all or specified cover tilt.</summary>
  ///<param name="target">The target for this service call</param>
  public void CloseCoverTilt(ServiceTarget target) => _haContext.CallService("cover", "close_cover_tilt", target);

  ///<summary>Open all or specified cover.</summary>
  ///<param name="target">The target for this service call</param>
  public void OpenCover(ServiceTarget target) => _haContext.CallService("cover", "open_cover", target);

  ///<summary>Open all or specified cover tilt.</summary>
  ///<param name="target">The target for this service call</param>
  public void OpenCoverTilt(ServiceTarget target) => _haContext.CallService("cover", "open_cover_tilt", target);

  ///<summary>Move to specific position all or specified cover.</summary>
  ///<param name="target">The target for this service call</param>
  public void SetCoverPosition(ServiceTarget target, CoverSetCoverPositionParameters data) => _haContext.CallService("cover", "set_cover_position", target, data);

  ///<summary>Move to specific position all or specified cover.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="position">Position of the cover</param>
  public void SetCoverPosition(ServiceTarget target, long position) => _haContext.CallService("cover", "set_cover_position", target,
  ...
  ///<param name="target">The target for this service call</param>
  public void SetCoverTiltPosition(ServiceTarget target, CoverSetCoverTiltPositionParameters data) => _haContext.CallService("cover", "set_cover_tilt_position", target, data);

  ///<summary>Move to specific position all or specified cover tilt.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="tiltPosition">Tilt position of the cover.</param>
  public void SetCoverTiltPosition(ServiceTarget target, long tiltPosition) => _haContext.CallService("cover", "set_cover_tilt_position", target,
        new CoverSetCoverTiltPositionParameters { TiltPosition = tiltPosition });

  ///<summary>Stop all or specified cover.</summary>
  ///<param name="target">The target for this service call</param>
  public void StopCover(ServiceTarget target) => _haContext.CallService("cover", "stop_cover", target);

  ///<summary>Stop all or specified cover.</summary>
  ///<param name="target">The target for this service call</param>
  public void StopCoverTilt(ServiceTarget target) => _haContext.CallService("cover", "stop_cover_tilt", target);

  ///<summary>Toggle a cover open/closed.</summary>
  ///<param name="target">The target for this service call</param>
  public void Toggle(ServiceTarget target) => _haContext.CallService("cover", "toggle", target);

  ///<summary>Toggle a cover tilt open/closed.</summary>
  ///<param name="target">The target for this service call</param>
  public void ToggleCoverTilt(ServiceTarget target) => _haContext.CallService("cover", "toggle_cover_tilt", target);
}
...
public class DeviceTrackerServices {
  ...
  public DeviceTrackerServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Control tracked device.</summary>
  public void See(DeviceTrackerSeeParameters data) => _haContext.CallService("device_tracker", "see", target: null, data);
  ...
  public void See(
      ...
      long? battery = null) => _haContext.CallService("device_tracker", "see", target: null,
...
public class FfmpegServices {
  ...
  public FfmpegServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Send a restart command to a ffmpeg based sensor.</summary>
  public void Restart(FfmpegRestartParameters data) => _haContext.CallService("ffmpeg", "restart", target: null, data);

  ///<summary>Send a restart command to a ffmpeg based sensor.</summary>
  ///<param name="entityId">Name of entity that will restart. Platform dependent.</param>
  public void Restart(string? entityId = null) => _haContext.CallService("ffmpeg", "restart", target: null, new FfmpegRestartParameters { EntityId = entityId });

  ///<summary>Send a start command to a ffmpeg based sensor.</summary>
  public void Start(FfmpegStartParameters data) => _haContext.CallService("ffmpeg", "start", target: null, data);

  ///<summary>Send a start command to a ffmpeg based sensor.</summary>
  ///<param name="entityId">Name of entity that will start. Platform dependent.</param>
  public void Start(string? entityId = null) => _haContext.CallService("ffmpeg", "start", target: null, new FfmpegStartParameters { EntityId = entityId });

  ///<summary>Send a stop command to a ffmpeg based sensor.</summary>
  public void Stop(FfmpegStopParameters data) => _haContext.CallService("ffmpeg", "stop", target: null, data);

  ///<summary>Send a stop command to a ffmpeg based sensor.</summary>
  ///<param name="entityId">Name of entity that will stop. Platform dependent.</param>
  public void Stop(string? entityId = null) => _haContext.CallService("ffmpeg", "stop", target: null, new FfmpegStopParameters { EntityId = entityId });
}
...
public class FrontendServices {
  ...
  public FrontendServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Reload themes from YAML configuration.</summary>
  public void ReloadThemes() => _haContext.CallService("frontend", "reload_themes");

  ///<summary>Set a theme unless the client selected per-device theme.</summary>
  public void SetTheme(FrontendSetThemeParameters data) => _haContext.CallService("frontend", "set_theme", target: null, data);

  ///<summary>Set a theme unless the client selected per-device theme.</summary>
  ///<param name="name">Name of a predefined theme eg: default</param>
  ///<param name="mode">The mode the theme is for.</param>
  public void SetTheme(object name, object? mode = null) => _haContext.CallService("frontend", "set_theme", target: null,
...
public class GroupServices {
  ...
  public GroupServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Reload group configuration, entities, and notify services.</summary>
  public void Reload() => _haContext.CallService("group", "reload");

  ///<summary>Remove a user group.</summary>
  public void Remove(GroupRemoveParameters data) => _haContext.CallService("group", "remove", target: null, data);

  ///<summary>Remove a user group.</summary>
  ///<param name="objectId">Group id and part of entity id. eg: test_group</param>
  public void Remove(object objectId) => _haContext.CallService("group", "remove", target: null, new GroupRemoveParameters { ObjectId = objectId });

  ///<summary>Create/Update a user group.</summary>
  public void Set(GroupSetParameters data) => _haContext.CallService("group", "set", target: null, data);
  ...
  public void Set(
      ...
      bool? all = null) => _haContext.CallService("group", "set", target: null,
...
public class HassioServices {
  ...
  public HassioServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Restart add-on.</summary>
  public void AddonRestart(HassioAddonRestartParameters data) => _haContext.CallService("hassio", "addon_restart", target: null, data);

  ///<summary>Restart add-on.</summary>
  ///<param name="addon">The add-on slug. eg: core_ssh</param>
  public void AddonRestart(string addon) => _haContext.CallService("hassio", "addon_restart", target: null,
        new HassioAddonRestartParameters { Addon = addon });

  ///<summary>Start add-on.</summary>
  public void AddonStart(HassioAddonStartParameters data) => _haContext.CallService("hassio", "addon_start", target: null, data);

  ///<summary>Start add-on.</summary>
  ///<param name="addon">The add-on slug. eg: core_ssh</param>
  public void AddonStart(string addon) => _haContext.CallService("hassio", "addon_start", target: null, new HassioAddonStartParameters { Addon = addon });

  ///<summary>Write data to add-on stdin.</summary>
  public void AddonStdin(HassioAddonStdinParameters data) => _haContext.CallService("hassio", "addon_stdin", target: null, data);

  ///<summary>Write data to add-on stdin.</summary>
  ///<param name="addon">The add-on slug. eg: core_ssh</param>
  public void AddonStdin(string addon) => _haContext.CallService("hassio", "addon_stdin", target: null, new HassioAddonStdinParameters { Addon = addon });

  ///<summary>Stop add-on.</summary>
  public void AddonStop(HassioAddonStopParameters data) => _haContext.CallService("hassio", "addon_stop", target: null, data);

  ///<summary>Stop add-on.</summary>
  ///<param name="addon">The add-on slug. eg: core_ssh</param>
  public void AddonStop(string addon) => _haContext.CallService("hassio", "addon_stop", target: null, new HassioAddonStopParameters { Addon = addon });
  ...
  /// </summary>
  public void AddonUpdate(HassioAddonUpdateParameters data) => _haContext.CallService("hassio", "addon_update", target: null, data);
  ...
  /// </summary>
  /// <param name="addon">The add-on slug. eg: core_ssh</param>
  public void AddonUpdate(string addon) => _haContext.CallService("hassio", "addon_update", target: null, new HassioAddonUpdateParameters { Addon = addon });

  ///<summary>Create a full backup.</summary>
  public void BackupFull(HassioBackupFullParameters data) => _haContext.CallService("hassio", "backup_full", target: null, data);
  ...
  public void BackupFull(string? name = null, string? password = null, bool? compressed = null) => _haContext.CallService("hassio", "backup_full", target: null,
        new HassioBackupFullParameters { Name = name, Password = password, Compressed = compressed });

  ///<summary>Create a partial backup.</summary>
  public void BackupPartial(HassioBackupPartialParameters data) => _haContext.CallService("hassio", "backup_partial", target: null, data);
  ...
  public void BackupPartial(
      ...
      bool? compressed = null) => _haContext.CallService("hassio", "backup_partial", target: null,
  ...
  public void HostReboot() => _haContext.CallService("hassio", "host_reboot");

  ///<summary>Poweroff the host system.</summary>
  public void HostShutdown() => _haContext.CallService("hassio", "host_shutdown");

  ///<summary>Restore from full backup.</summary>
  public void RestoreFull(HassioRestoreFullParameters data) => _haContext.CallService("hassio", "restore_full", target: null, data);

  ///<summary>Restore from full backup.</summary>
  ///<param name="slug">Slug of backup to restore from.</param>
  ///<param name="password">Optional password. eg: password</param>
  public void RestoreFull(string slug, string? password = null) => _haContext.CallService("hassio", "restore_full", target: null,
        new HassioRestoreFullParameters { Slug = slug, Password = password });

  ///<summary>Restore from partial backup.</summary>
  public void RestorePartial(HassioRestorePartialParameters data) => _haContext.CallService("hassio", "restore_partial", target: null, data);
  ...
  public void RestorePartial(
      ...
      object? folders = null,
      object? addons = null,
      string? password = null) => _haContext.CallService("hassio", "restore_partial", target: null,
...
public class HomeassistantServices {
  ...
  public HomeassistantServices(IHaContext haContext) => _haContext = haContext;
  ...
  public void CheckConfig() => _haContext.CallService("homeassistant", "check_config");

  ///<summary>Reload a config entry that matches a target.</summary>
  ///<param name="target">The target for this service call</param>
  public void ReloadConfigEntry(ServiceTarget target, HomeassistantReloadConfigEntryParameters data) => _haContext.CallService("homeassistant", "reload_config_entry", target, data);

  ///<summary>Reload a config entry that matches a target.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="entryId">A configuration entry id eg: 8955375327824e14ba89e4b29cc3ec9a</param>
  public void ReloadConfigEntry(ServiceTarget target, string? entryId = null) => _haContext.CallService("homeassistant", "reload_config_entry", target,
        new HomeassistantReloadConfigEntryParameters { EntryId = entryId });

  ///<summary>Reload the core configuration.</summary>
  public void ReloadCoreConfig() => _haContext.CallService("homeassistant", "reload_core_config");

  ///<summary>Restart the Home Assistant service.</summary>
  public void Restart() => _haContext.CallService("homeassistant", "restart");

  /// <summary>
  ///     Save the persistent states (for entities derived from RestoreEntity) immediately. Maintain the normal periodic
  ///     saving interval.
  /// </summary>
  public void SavePersistentStates() => _haContext.CallService("homeassistant", "save_persistent_states");

  ///<summary>Update the Home Assistant location.</summary>
  public void SetLocation(HomeassistantSetLocationParameters data) => _haContext.CallService("homeassistant", "set_location", target: null, data);
  ...
  public void SetLocation(string latitude, string longitude) => _haContext.CallService("homeassistant", "set_location", target: null,
  ...
  public void Stop() => _haContext.CallService("homeassistant", "stop");

  ///<summary>Generic service to toggle devices on/off under any domain</summary>
  ///<param name="target">The target for this service call</param>
  public void Toggle(ServiceTarget target) => _haContext.CallService("homeassistant", "toggle", target);

  ///<summary>Generic service to turn devices off under any domain.</summary>
  ///<param name="target">The target for this service call</param>
  public void TurnOff(ServiceTarget target) => _haContext.CallService("homeassistant", "turn_off", target);

  ///<summary>Generic service to turn devices on under any domain.</summary>
  ///<param name="target">The target for this service call</param>
  public void TurnOn(ServiceTarget target) => _haContext.CallService("homeassistant", "turn_on", target);

  ///<summary>Force one or more entities to update its data</summary>
  ///<param name="target">The target for this service call</param>
  public void UpdateEntity(ServiceTarget target) => _haContext.CallService("homeassistant", "update_entity", target);
}
...
public class InputBooleanServices {
  ...
  public InputBooleanServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Reload the input_boolean configuration</summary>
  public void Reload() => _haContext.CallService("input_boolean", "reload");

  ///<summary>Toggle an input boolean</summary>
  ///<param name="target">The target for this service call</param>
  public void Toggle(ServiceTarget target) => _haContext.CallService("input_boolean", "toggle", target);

  ///<summary>Turn off an input boolean</summary>
  ///<param name="target">The target for this service call</param>
  public void TurnOff(ServiceTarget target) => _haContext.CallService("input_boolean", "turn_off", target);

  ///<summary>Turn on an input boolean</summary>
  ///<param name="target">The target for this service call</param>
  public void TurnOn(ServiceTarget target) => _haContext.CallService("input_boolean", "turn_on", target);
}

public class InputButtonServices {
  private readonly IHaContext _haContext;

  public InputButtonServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Press the input button entity.</summary>
  ///<param name="target">The target for this service call</param>
  public void Press(ServiceTarget target) => _haContext.CallService("input_button", "press", target);

  public void Reload() => _haContext.CallService("input_button", "reload");
}

public class InputDatetimeServices {
  private readonly IHaContext _haContext;

  public InputDatetimeServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Reload the input_datetime configuration.</summary>
  public void Reload() => _haContext.CallService("input_datetime", "reload");

  ///<summary>This can be used to dynamically set the date and/or time.</summary>
  ///<param name="target">The target for this service call</param>
  public void SetDatetime(ServiceTarget target, InputDatetimeSetDatetimeParameters data) => _haContext.CallService("input_datetime", "set_datetime", target, data);
  ...
  public void SetDatetime(
      ...
      long? timestamp = null) => _haContext.CallService("input_datetime", "set_datetime", target,
...
public class InputNumberServices {
  ...
  public InputNumberServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Decrement the value of an input number entity by its stepping.</summary>
  ///<param name="target">The target for this service call</param>
  public void Decrement(ServiceTarget target) => _haContext.CallService("input_number", "decrement", target);

  ///<summary>Increment the value of an input number entity by its stepping.</summary>
  ///<param name="target">The target for this service call</param>
  public void Increment(ServiceTarget target) => _haContext.CallService("input_number", "increment", target);

  ///<summary>Reload the input_number configuration.</summary>
  public void Reload() => _haContext.CallService("input_number", "reload");

  ///<summary>Set the value of an input number entity.</summary>
  ///<param name="target">The target for this service call</param>
  public void SetValue(ServiceTarget target, InputNumberSetValueParameters data) => _haContext.CallService("input_number", "set_value", target, data);

  ///<summary>Set the value of an input number entity.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="value">The target value the entity should be set to.</param>
  public void SetValue(ServiceTarget target, double value) => _haContext.CallService("input_number", "set_value", target, new InputNumberSetValueParameters { Value = value });
}
...
public class InputSelectServices {
  ...
  public InputSelectServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Reload the input_select configuration.</summary>
  public void Reload() => _haContext.CallService("input_select", "reload");

  ///<summary>Select the first option of an input select entity.</summary>
  ///<param name="target">The target for this service call</param>
  public void SelectFirst(ServiceTarget target) => _haContext.CallService("input_select", "select_first", target);

  ///<summary>Select the last option of an input select entity.</summary>
  ///<param name="target">The target for this service call</param>
  public void SelectLast(ServiceTarget target) => _haContext.CallService("input_select", "select_last", target);

  ///<summary>Select the next options of an input select entity.</summary>
  ///<param name="target">The target for this service call</param>
  public void SelectNext(ServiceTarget target, InputSelectSelectNextParameters data) => _haContext.CallService("input_select", "select_next", target, data);

  ///<summary>Select the next options of an input select entity.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="cycle">If the option should cycle from the last to the first.</param>
  public void SelectNext(ServiceTarget target, bool? cycle = null) => _haContext.CallService("input_select", "select_next", target,
        new InputSelectSelectNextParameters { Cycle = cycle });

  ///<summary>Select an option of an input select entity.</summary>
  ///<param name="target">The target for this service call</param>
  public void SelectOption(ServiceTarget target, InputSelectSelectOptionParameters data) => _haContext.CallService("input_select", "select_option", target, data);

  ///<summary>Select an option of an input select entity.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="option">Option to be selected. eg: "Item A"</param>
  public void SelectOption(ServiceTarget target, string option) => _haContext.CallService("input_select", "select_option", target,
        new InputSelectSelectOptionParameters { Option = option });

  ///<summary>Select the previous options of an input select entity.</summary>
  ///<param name="target">The target for this service call</param>
  public void SelectPrevious(ServiceTarget target, InputSelectSelectPreviousParameters data) => _haContext.CallService("input_select", "select_previous", target, data);

  ///<summary>Select the previous options of an input select entity.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="cycle">If the option should cycle from the first to the last.</param>
  public void SelectPrevious(ServiceTarget target, bool? cycle = null) => _haContext.CallService("input_select", "select_previous", target,
        new InputSelectSelectPreviousParameters { Cycle = cycle });

  ///<summary>Set the options of an input select entity.</summary>
  ///<param name="target">The target for this service call</param>
  public void SetOptions(ServiceTarget target, InputSelectSetOptionsParameters data) => _haContext.CallService("input_select", "set_options", target, data);

  ///<summary>Set the options of an input select entity.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="options">Options for the input select entity. eg: ["Item A", "Item B", "Item C"]</param>
  public void SetOptions(ServiceTarget target, object options) => _haContext.CallService("input_select", "set_options", target,
...
public class InputTextServices {
  ...
  public InputTextServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Reload the input_text configuration.</summary>
  public void Reload() => _haContext.CallService("input_text", "reload");

  ///<summary>Set the value of an input text entity.</summary>
  ///<param name="target">The target for this service call</param>
  public void SetValue(ServiceTarget target, InputTextSetValueParameters data) => _haContext.CallService("input_text", "set_value", target, data);

  ///<summary>Set the value of an input text entity.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="value">The target value the entity should be set to. eg: This is an example text</param>
  public void SetValue(ServiceTarget target, string value) => _haContext.CallService("input_text", "set_value", target, new InputTextSetValueParameters { Value = value });
}
...
public class LightServices {
  ...
  public LightServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Toggles one or more lights, from on to off, or, off to on, based on their current state. </summary>
  ///<param name="target">The target for this service call</param>
  public void Toggle(ServiceTarget target, LightToggleParameters data) => _haContext.CallService("light", "toggle", target, data);
  ...
  public void Toggle(
      ...
      string? profile = null,
      object? flash = null,
      string? effect = null) => _haContext.CallService("light", "toggle", target,
  ...
  ///<param name="target">The target for this service call</param>
  public void TurnOff(ServiceTarget target, LightTurnOffParameters data) => _haContext.CallService("light", "turn_off", target, data);

  ///<summary>Turns off one or more lights.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="transition">Duration it takes to get to next state.</param>
  ///<param name="flash">If the light should flash.</param>
  public void TurnOff(ServiceTarget target, long? transition = null, object? flash = null) => _haContext.CallService("light", "turn_off", target,
  ...
  ///<param name="target">The target for this service call</param>
  public void TurnOn(ServiceTarget target, LightTurnOnParameters data) => _haContext.CallService("light", "turn_on", target, data);
  ...
  public void TurnOn(
      ...
      string? profile = null,
      object? flash = null,
      string? effect = null) => _haContext.CallService("light", "turn_on", target,
...
public class LockServices {
  ...
  public LockServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Lock all or specified locks.</summary>
  ///<param name="target">The target for this service call</param>
  public void Lock(ServiceTarget target, LockLockParameters data) => _haContext.CallService("lock", "lock", target, data);

  ///<summary>Lock all or specified locks.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="code">An optional code to lock the lock with. eg: 1234</param>
  public void Lock(ServiceTarget target, string? code = null) => _haContext.CallService("lock", "lock", target, new LockLockParameters { Code = code });

  ///<summary>Open all or specified locks.</summary>
  ///<param name="target">The target for this service call</param>
  public void Open(ServiceTarget target, LockOpenParameters data) => _haContext.CallService("lock", "open", target, data);

  ///<summary>Open all or specified locks.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="code">An optional code to open the lock with. eg: 1234</param>
  public void Open(ServiceTarget target, string? code = null) => _haContext.CallService("lock", "open", target, new LockOpenParameters { Code = code });

  ///<summary>Unlock all or specified locks.</summary>
  ///<param name="target">The target for this service call</param>
  public void Unlock(ServiceTarget target, LockUnlockParameters data) => _haContext.CallService("lock", "unlock", target, data);

  ///<summary>Unlock all or specified locks.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="code">An optional code to unlock the lock with. eg: 1234</param>
  public void Unlock(ServiceTarget target, string? code = null) => _haContext.CallService("lock", "unlock", target, new LockUnlockParameters { Code = code });
}
...
public class LogbookServices {
  ...
  public LogbookServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Create a custom entry in your logbook.</summary>
  public void Log(LogbookLogParameters data) => _haContext.CallService("logbook", "log", target: null, data);
  ...
  public void Log(string name, string message, string? entityId = null, string? domain = null) => _haContext.CallService("logbook", "log", target: null,
...
public class LovelaceServices {
  ...
  public LovelaceServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Reload Lovelace resources from YAML configuration</summary>
  public void ReloadResources() => _haContext.CallService("lovelace", "reload_resources");
}

public class NotifyServices {
  private readonly IHaContext _haContext;

  public NotifyServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Sends a notification message using the mobile_app_dn2103 integration.</summary>
  public void MobileAppDn2103(NotifyMobileAppDn2103Parameters data) => _haContext.CallService("notify", "mobile_app_dn2103", target: null, data);
  ...
  public void MobileAppDn2103(string message, string? title = null, object? target = null, object? data = null) => _haContext.CallService("notify", "mobile_app_dn2103", target: null,
  ...
  public void MobileAppLe2123(NotifyMobileAppLe2123Parameters data) => _haContext.CallService("notify", "mobile_app_le2123", target: null, data);
  ...
  /// </param>
  /// <param name="data">Extended information for notification. Optional depending on the platform. eg: platform specific</param>
  public void MobileAppLe2123(string message, string? title = null, object? target = null, object? data = null) => _haContext.CallService("notify", "mobile_app_le2123", target: null,
        new NotifyMobileAppLe2123Parameters { Message = message, Title = title, Target = target, Data = data });

  ///<summary>Sends a notification message using the notify service.</summary>
  public void Notify(NotifyNotifyParameters data) => _haContext.CallService("notify", "notify", target: null, data);
  ...
  /// </param>
  /// <param name="data">Extended information for notification. Optional depending on the platform. eg: platform specific</param>
  public void Notify(string message, string? title = null, object? target = null, object? data = null) => _haContext.CallService("notify", "notify", target: null,
  ...
  public void PersistentNotification(NotifyPersistentNotificationParameters data) => _haContext.CallService("notify", "persistent_notification", target: null, data);

  ///<summary>Sends a notification that is visible in the front-end.</summary>
  ///<param name="message">Message body of the notification. eg: The garage door has been open for 10 minutes.</param>
  ///<param name="title">Title for your notification. eg: Your Garage Door Friend</param>
  public void PersistentNotification(string message, string? title = null) => _haContext.CallService("notify", "persistent_notification", target: null,
  ...
  public void Tibber(NotifyTibberParameters data) => _haContext.CallService("notify", "tibber", target: null, data);
  ...
  /// </param>
  /// <param name="data">Extended information for notification. Optional depending on the platform. eg: platform specific</param>
  public void Tibber(string message, string? title = null, object? target = null, object? data = null) => _haContext.CallService("notify", "tibber", target: null,
...
public class NumberServices {
  ...
  public NumberServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Set the value of a Number entity.</summary>
  ///<param name="target">The target for this service call</param>
  public void SetValue(ServiceTarget target, NumberSetValueParameters data) => _haContext.CallService("number", "set_value", target, data);

  ///<summary>Set the value of a Number entity.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="value">The target value the entity should be set to. eg: 42</param>
  public void SetValue(ServiceTarget target, string? value = null) => _haContext.CallService("number", "set_value", target, new NumberSetValueParameters { Value = value });
}
...
public class PersistentNotificationServices {
  ...
  public PersistentNotificationServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Show a notification in the frontend.</summary>
  public void Create(PersistentNotificationCreateParameters data) => _haContext.CallService("persistent_notification", "create", target: null, data);
  ...
  public void Create(string message, string? title = null, string? notificationId = null) => _haContext.CallService("persistent_notification", "create", target: null,
  ...
  public void Dismiss(PersistentNotificationDismissParameters data) => _haContext.CallService("persistent_notification", "dismiss", target: null, data);

  ///<summary>Remove a notification from the frontend.</summary>
  ///<param name="notificationId">Target ID of the notification, which should be removed. eg: 1234</param>
  public void Dismiss(string notificationId) => _haContext.CallService("persistent_notification", "dismiss", target: null,
        new PersistentNotificationDismissParameters { NotificationId = notificationId });

  ///<summary>Mark a notification read.</summary>
  public void MarkRead(PersistentNotificationMarkReadParameters data) => _haContext.CallService("persistent_notification", "mark_read", target: null, data);

  ///<summary>Mark a notification read.</summary>
  ///<param name="notificationId">Target ID of the notification, which should be mark read. eg: 1234</param>
  public void MarkRead(string notificationId) => _haContext.CallService("persistent_notification", "mark_read", target: null,
...
public class PersonServices {
  ...
  public PersonServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Reload the person configuration.</summary>
  public void Reload() => _haContext.CallService("person", "reload");
}

public class PythonScriptServices {
  private readonly IHaContext _haContext;

  public PythonScriptServices(IHaContext haContext) => _haContext = haContext;

  public void HelloWorld() => _haContext.CallService("python_script", "hello_world");

  ///<summary>Reload all available python_scripts</summary>
  public void Reload() => _haContext.CallService("python_script", "reload");
}

public class RecorderServices {
  private readonly IHaContext _haContext;

  public RecorderServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Stop the recording of events and state changes</summary>
  public void Disable() => _haContext.CallService("recorder", "disable");

  ///<summary>Start the recording of events and state changes</summary>
  public void Enable() => _haContext.CallService("recorder", "enable");

  ///<summary>Start purge task - to clean up old data from your database.</summary>
  public void Purge(RecorderPurgeParameters data) => _haContext.CallService("recorder", "purge", target: null, data);
  ...
  public void Purge(long? keepDays = null, bool? repack = null, bool? applyFilter = null) => _haContext.CallService("recorder", "purge", target: null,
  ...
  ///<param name="target">The target for this service call</param>
  public void PurgeEntities(ServiceTarget target, RecorderPurgeEntitiesParameters data) => _haContext.CallService("recorder", "purge_entities", target, data);
  ...
  ///     domain*.object_id*
  /// </param>
  public void PurgeEntities(ServiceTarget target, object? domains = null, object? entityGlobs = null) => _haContext.CallService("recorder", "purge_entities", target,
...
public class SceneServices {
  ...
  public SceneServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Activate a scene with configuration.</summary>
  public void Apply(SceneApplyParameters data) => _haContext.CallService("scene", "apply", target: null, data);
  ...
  public void Apply(object entities, long? transition = null) => _haContext.CallService("scene", "apply", target: null,
        new SceneApplyParameters { Entities = entities, Transition = transition });

  ///<summary>Creates a new scene.</summary>
  public void Create(SceneCreateParameters data) => _haContext.CallService("scene", "create", target: null, data);
  ...
  public void Create(string sceneId, object? entities = null, object? snapshotEntities = null) => _haContext.CallService("scene", "create", target: null,
  ...
  public void Reload() => _haContext.CallService("scene", "reload");

  ///<summary>Activate a scene.</summary>
  ///<param name="target">The target for this service call</param>
  public void TurnOn(ServiceTarget target, SceneTurnOnParameters data) => _haContext.CallService("scene", "turn_on", target, data);

  ///<summary>Activate a scene.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="transition">Transition duration it takes to bring devices to the state defined in the scene.</param>
  public void TurnOn(ServiceTarget target, long? transition = null) => _haContext.CallService("scene", "turn_on", target, new SceneTurnOnParameters { Transition = transition });
}
...
public class ScriptServices {
  ...
  public ScriptServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Reload all the available scripts</summary>
  public void Reload() => _haContext.CallService("script", "reload");

  ///<summary>Toggle script</summary>
  ///<param name="target">The target for this service call</param>
  public void Toggle(ServiceTarget target) => _haContext.CallService("script", "toggle", target);

  ///<summary>Turn off script</summary>
  ///<param name="target">The target for this service call</param>
  public void TurnOff(ServiceTarget target) => _haContext.CallService("script", "turn_off", target);

  ///<summary>Turn on script</summary>
  ///<param name="target">The target for this service call</param>
  public void TurnOn(ServiceTarget target) => _haContext.CallService("script", "turn_on", target);
}

public class SelectServices {
  private readonly IHaContext _haContext;

  public SelectServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Select an option of an select entity.</summary>
  ///<param name="target">The target for this service call</param>
  public void SelectOption(ServiceTarget target, SelectSelectOptionParameters data) => _haContext.CallService("select", "select_option", target, data);

  ///<summary>Select an option of an select entity.</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="option">Option to be selected. eg: "Item A"</param>
  public void SelectOption(ServiceTarget target, string option) => _haContext.CallService("select", "select_option", target, new SelectSelectOptionParameters { Option = option });
}
...
public class SirenServices {
  ...
  public SirenServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Toggles a siren.</summary>
  ///<param name="target">The target for this service call</param>
  public void Toggle(ServiceTarget target) => _haContext.CallService("siren", "toggle", target);

  ///<summary>Turn siren off.</summary>
  ///<param name="target">The target for this service call</param>
  public void TurnOff(ServiceTarget target) => _haContext.CallService("siren", "turn_off", target);

  ///<summary>Turn siren on.</summary>
  ///<param name="target">The target for this service call</param>
  public void TurnOn(ServiceTarget target, SirenTurnOnParameters data) => _haContext.CallService("siren", "turn_on", target, data);
  ...
  ///     integration. eg: 15
  /// </param>
  public void TurnOn(ServiceTarget target, string? tone = null, double? volumeLevel = null, string? duration = null) => _haContext.CallService("siren", "turn_on", target,
...
public class SpeedtestdotnetServices {
  ...
  public SpeedtestdotnetServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Immediately execute a speed test with Speedtest.net</summary>
  public void Speedtest() => _haContext.CallService("speedtestdotnet", "speedtest");
}

public class SwitchServices {
  private readonly IHaContext _haContext;

  public SwitchServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Toggles a switch state</summary>
  ///<param name="target">The target for this service call</param>
  public void Toggle(ServiceTarget target) => _haContext.CallService("switch", "toggle", target);

  ///<summary>Turn a switch off</summary>
  ///<param name="target">The target for this service call</param>
  public void TurnOff(ServiceTarget target) => _haContext.CallService("switch", "turn_off", target);

  ///<summary>Turn a switch on</summary>
  ///<param name="target">The target for this service call</param>
  public void TurnOn(ServiceTarget target) => _haContext.CallService("switch", "turn_on", target);
}

public class SystemLogServices {
  private readonly IHaContext _haContext;

  public SystemLogServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Clear all log entries.</summary>
  public void Clear() => _haContext.CallService("system_log", "clear");

  ///<summary>Write log entry.</summary>
  public void Write(SystemLogWriteParameters data) => _haContext.CallService("system_log", "write", target: null, data);
  ...
  /// </param>
  public void Write(string message, object? level = null, string? logger = null) => _haContext.CallService("system_log", "write", target: null,
...
public class TemplateServices {
  ...
  public TemplateServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Reload all template entities.</summary>
  public void Reload() => _haContext.CallService("template", "reload");
}

public class TimerServices {
  private readonly IHaContext _haContext;

  public TimerServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Cancel a timer.</summary>
  ///<param name="target">The target for this service call</param>
  public void Cancel(ServiceTarget target) => _haContext.CallService("timer", "cancel", target);

  ///<summary>Finish a timer.</summary>
  ///<param name="target">The target for this service call</param>
  public void Finish(ServiceTarget target) => _haContext.CallService("timer", "finish", target);

  ///<summary>Pause a timer.</summary>
  ///<param name="target">The target for this service call</param>
  public void Pause(ServiceTarget target) => _haContext.CallService("timer", "pause", target);

  public void Reload() => _haContext.CallService("timer", "reload");

  ///<summary>Start a timer</summary>
  ///<param name="target">The target for this service call</param>
  public void Start(ServiceTarget target, TimerStartParameters data) => _haContext.CallService("timer", "start", target, data);

  ///<summary>Start a timer</summary>
  ///<param name="target">The target for this service call</param>
  ///<param name="duration">Duration the timer requires to finish. [optional] eg: 00:01:00 or 60</param>
  public void Start(ServiceTarget target, string? duration = null) => _haContext.CallService("timer", "start", target, new TimerStartParameters { Duration = duration });
}
...
public class TtsServices {
  ...
  public TtsServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Remove all text-to-speech cache files and RAM cache.</summary>
  public void ClearCache() => _haContext.CallService("tts", "clear_cache");

  ///<summary>Say something using text-to-speech on a media player with google_translate.</summary>
  public void GoogleTranslateSay(TtsGoogleTranslateSayParameters data) => _haContext.CallService("tts", "google_translate_say", target: null, data);
  ...
  public void GoogleTranslateSay(
      ...
      object? options = null) => _haContext.CallService("tts", "google_translate_say", target: null,
...
public class UpdateServices {
  ...
  public UpdateServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Removes the skipped version marker from an update.</summary>
  ///<param name="target">The target for this service call</param>
  public void ClearSkipped(ServiceTarget target) => _haContext.CallService("update", "clear_skipped", target);

  ///<summary>Install an update for this device or service</summary>
  ///<param name="target">The target for this service call</param>
  public void Install(ServiceTarget target, UpdateInstallParameters data) => _haContext.CallService("update", "install", target, data);
  ...
  public void Install(ServiceTarget target, string? version = null, bool? backup = null) => _haContext.CallService("update", "install", target,
        new UpdateInstallParameters { Version = version, Backup = backup });

  ///<summary>Mark currently available update as skipped.</summary>
  ///<param name="target">The target for this service call</param>
  public void Skip(ServiceTarget target) => _haContext.CallService("update", "skip", target);
}
...
public class ZoneServices {
  ...
  public ZoneServices(IHaContext haContext) => _haContext = haContext;

  ///<summary>Reload the YAML-based zone configuration.</summary>
  public void Reload() => _haContext.CallService("zone", "reload");
}

public static class AutomationEntityExtensionMethods {
  ///<summary>Toggle (enable / disable) an automation.</summary>
  public static void Toggle(this AutomationEntity target) => target.CallService("toggle");

  ///<summary>Toggle (enable / disable) an automation.</summary>
  public static void Toggle(this IEnumerable<AutomationEntity> target) => target.CallService("toggle");

  ///<summary>Trigger the actions of an automation.</summary>
  public static void Trigger(this AutomationEntity target, AutomationTriggerParameters data) => target.CallService("trigger", data);

  ///<summary>Trigger the actions of an automation.</summary>
  public static void Trigger(this IEnumerable<AutomationEntity> target, AutomationTriggerParameters data) => target.CallService("trigger", data);

  ///<summary>Trigger the actions of an automation.</summary>
  ///<param name="target">The AutomationEntity to call this service for</param>
  ///<param name="skipCondition">Whether or not the conditions will be skipped.</param>
  public static void Trigger(this AutomationEntity target, bool? skipCondition = null) => target.CallService("trigger", new AutomationTriggerParameters { SkipCondition = skipCondition });

  ///<summary>Trigger the actions of an automation.</summary>
  ///<param name="target">The IEnumerable<AutomationEntity> to call this service for</param>
  ///<param name="skipCondition">Whether or not the conditions will be skipped.</param>
  public static void Trigger(this IEnumerable<AutomationEntity> target, bool? skipCondition = null) => target.CallService("trigger", new AutomationTriggerParameters { SkipCondition = skipCondition });

  ///<summary>Disable an automation.</summary>
  public static void TurnOff(this AutomationEntity target, AutomationTurnOffParameters data) => target.CallService("turn_off", data);

  ///<summary>Disable an automation.</summary>
  public static void TurnOff(this IEnumerable<AutomationEntity> target, AutomationTurnOffParameters data) => target.CallService("turn_off", data);

  ///<summary>Disable an automation.</summary>
  ///<param name="target">The AutomationEntity to call this service for</param>
  ///<param name="stopActions">Stop currently running actions.</param>
  public static void TurnOff(this AutomationEntity target, bool? stopActions = null) => target.CallService("turn_off", new AutomationTurnOffParameters { StopActions = stopActions });

  ///<summary>Disable an automation.</summary>
  ///<param name="target">The IEnumerable<AutomationEntity> to call this service for</param>
  ///<param name="stopActions">Stop currently running actions.</param>
  public static void TurnOff(this IEnumerable<AutomationEntity> target, bool? stopActions = null) => target.CallService("turn_off", new AutomationTurnOffParameters { StopActions = stopActions });

  ///<summary>Enable an automation.</summary>
  public static void TurnOn(this AutomationEntity target) => target.CallService("turn_on");

  ///<summary>Enable an automation.</summary>
  public static void TurnOn(this IEnumerable<AutomationEntity> target) => target.CallService("turn_on");
}

public static class ButtonEntityExtensionMethods {
  ///<summary>Press the button entity.</summary>
  public static void Press(this ButtonEntity target) => target.CallService("press");

  ///<summary>Press the button entity.</summary>
  public static void Press(this IEnumerable<ButtonEntity> target) => target.CallService("press");
}

public static class CoverEntityExtensionMethods {
  ///<summary>Close all or specified cover.</summary>
  public static void CloseCover(this CoverEntity target) => target.CallService("close_cover");

  ///<summary>Close all or specified cover.</summary>
  public static void CloseCover(this IEnumerable<CoverEntity> target) => target.CallService("close_cover");

  ///<summary>Close all or specified cover tilt.</summary>
  public static void CloseCoverTilt(this CoverEntity target) => target.CallService("close_cover_tilt");

  ///<summary>Close all or specified cover tilt.</summary>
  public static void CloseCoverTilt(this IEnumerable<CoverEntity> target) => target.CallService("close_cover_tilt");

  ///<summary>Open all or specified cover.</summary>
  public static void OpenCover(this CoverEntity target) => target.CallService("open_cover");

  ///<summary>Open all or specified cover.</summary>
  public static void OpenCover(this IEnumerable<CoverEntity> target) => target.CallService("open_cover");

  ///<summary>Open all or specified cover tilt.</summary>
  public static void OpenCoverTilt(this CoverEntity target) => target.CallService("open_cover_tilt");

  ///<summary>Open all or specified cover tilt.</summary>
  public static void OpenCoverTilt(this IEnumerable<CoverEntity> target) => target.CallService("open_cover_tilt");

  ///<summary>Move to specific position all or specified cover.</summary>
  public static void SetCoverPosition(this CoverEntity target, CoverSetCoverPositionParameters data) => target.CallService("set_cover_position", data);

  ///<summary>Move to specific position all or specified cover.</summary>
  public static void SetCoverPosition(this IEnumerable<CoverEntity> target, CoverSetCoverPositionParameters data) => target.CallService("set_cover_position", data);

  ///<summary>Move to specific position all or specified cover.</summary>
  ///<param name="target">The CoverEntity to call this service for</param>
  ///<param name="position">Position of the cover</param>
  public static void SetCoverPosition(this CoverEntity target, long position) => target.CallService("set_cover_position", new CoverSetCoverPositionParameters { Position = position });

  ///<summary>Move to specific position all or specified cover.</summary>
  ///<param name="target">The IEnumerable<CoverEntity> to call this service for</param>
  ///<param name="position">Position of the cover</param>
  public static void SetCoverPosition(this IEnumerable<CoverEntity> target, long position) => target.CallService("set_cover_position", new CoverSetCoverPositionParameters { Position = position });

  ///<summary>Move to specific position all or specified cover tilt.</summary>
  public static void SetCoverTiltPosition(this CoverEntity target, CoverSetCoverTiltPositionParameters data) => target.CallService("set_cover_tilt_position", data);

  ///<summary>Move to specific position all or specified cover tilt.</summary>
  public static void SetCoverTiltPosition(
      this IEnumerable<CoverEntity> target,
      CoverSetCoverTiltPositionParameters data) => target.CallService("set_cover_tilt_position", data);

  ///<summary>Move to specific position all or specified cover tilt.</summary>
  ///<param name="target">The CoverEntity to call this service for</param>
  ///<param name="tiltPosition">Tilt position of the cover.</param>
  public static void SetCoverTiltPosition(this CoverEntity target, long tiltPosition) => target.CallService("set_cover_tilt_position",
        new CoverSetCoverTiltPositionParameters { TiltPosition = tiltPosition });

  ///<summary>Move to specific position all or specified cover tilt.</summary>
  ///<param name="target">The IEnumerable<CoverEntity> to call this service for</param>
  ///<param name="tiltPosition">Tilt position of the cover.</param>
  public static void SetCoverTiltPosition(this IEnumerable<CoverEntity> target, long tiltPosition) => target.CallService("set_cover_tilt_position",
        new CoverSetCoverTiltPositionParameters { TiltPosition = tiltPosition });

  ///<summary>Stop all or specified cover.</summary>
  public static void StopCover(this CoverEntity target) => target.CallService("stop_cover");

  ///<summary>Stop all or specified cover.</summary>
  public static void StopCover(this IEnumerable<CoverEntity> target) => target.CallService("stop_cover");

  ///<summary>Stop all or specified cover.</summary>
  public static void StopCoverTilt(this CoverEntity target) => target.CallService("stop_cover_tilt");

  ///<summary>Stop all or specified cover.</summary>
  public static void StopCoverTilt(this IEnumerable<CoverEntity> target) => target.CallService("stop_cover_tilt");

  ///<summary>Toggle a cover open/closed.</summary>
  public static void Toggle(this CoverEntity target) => target.CallService("toggle");

  ///<summary>Toggle a cover open/closed.</summary>
  public static void Toggle(this IEnumerable<CoverEntity> target) => target.CallService("toggle");

  ///<summary>Toggle a cover tilt open/closed.</summary>
  public static void ToggleCoverTilt(this CoverEntity target) => target.CallService("toggle_cover_tilt");

  ///<summary>Toggle a cover tilt open/closed.</summary>
  public static void ToggleCoverTilt(this IEnumerable<CoverEntity> target) => target.CallService("toggle_cover_tilt");
}

public static class InputBooleanEntityExtensionMethods {
  ///<summary>Toggle an input boolean</summary>
  public static void Toggle(this InputBooleanEntity target) => target.CallService("toggle");

  ///<summary>Toggle an input boolean</summary>
  public static void Toggle(this IEnumerable<InputBooleanEntity> target) => target.CallService("toggle");

  ///<summary>Turn off an input boolean</summary>
  public static void TurnOff(this InputBooleanEntity target) => target.CallService("turn_off");

  ///<summary>Turn off an input boolean</summary>
  public static void TurnOff(this IEnumerable<InputBooleanEntity> target) => target.CallService("turn_off");

  ///<summary>Turn on an input boolean</summary>
  public static void TurnOn(this InputBooleanEntity target) => target.CallService("turn_on");

  ///<summary>Turn on an input boolean</summary>
  public static void TurnOn(this IEnumerable<InputBooleanEntity> target) => target.CallService("turn_on");
}

public static class InputNumberEntityExtensionMethods {
  ///<summary>Decrement the value of an input number entity by its stepping.</summary>
  public static void Decrement(this InputNumberEntity target) => target.CallService("decrement");

  ///<summary>Decrement the value of an input number entity by its stepping.</summary>
  public static void Decrement(this IEnumerable<InputNumberEntity> target) => target.CallService("decrement");

  ///<summary>Increment the value of an input number entity by its stepping.</summary>
  public static void Increment(this InputNumberEntity target) => target.CallService("increment");

  ///<summary>Increment the value of an input number entity by its stepping.</summary>
  public static void Increment(this IEnumerable<InputNumberEntity> target) => target.CallService("increment");

  ///<summary>Set the value of an input number entity.</summary>
  public static void SetValue(this InputNumberEntity target, InputNumberSetValueParameters data) => target.CallService("set_value", data);

  ///<summary>Set the value of an input number entity.</summary>
  public static void SetValue(this IEnumerable<InputNumberEntity> target, InputNumberSetValueParameters data) => target.CallService("set_value", data);

  ///<summary>Set the value of an input number entity.</summary>
  ///<param name="target">The InputNumberEntity to call this service for</param>
  ///<param name="value">The target value the entity should be set to.</param>
  public static void SetValue(this InputNumberEntity target, double value) => target.CallService("set_value", new InputNumberSetValueParameters { Value = value });

  ///<summary>Set the value of an input number entity.</summary>
  ///<param name="target">The IEnumerable<InputNumberEntity> to call this service for</param>
  ///<param name="value">The target value the entity should be set to.</param>
  public static void SetValue(this IEnumerable<InputNumberEntity> target, double value) => target.CallService("set_value", new InputNumberSetValueParameters { Value = value });
}

public static class LightEntityExtensionMethods {
  ///<summary>Toggles one or more lights, from on to off, or, off to on, based on their current state. </summary>
  public static void Toggle(this LightEntity target, LightToggleParameters data) => target.CallService("toggle", data);

  ///<summary>Toggles one or more lights, from on to off, or, off to on, based on their current state. </summary>
  public static void Toggle(this IEnumerable<LightEntity> target, LightToggleParameters data) => target.CallService("toggle", data);
  ...
  public static void Toggle(
      ...
      string? profile = null,
      object? flash = null,
      string? effect = null) => target.CallService("toggle",
        new LightToggleParameters {
          Transition = transition, RgbColor = rgbColor, ColorName = colorName, HsColor = hsColor,
          XyColor = xyColor, ColorTemp = colorTemp, Kelvin = kelvin, WhiteValue = whiteValue,
          Brightness = brightness, BrightnessPct = brightnessPct, Profile = profile, Flash = flash,
  ...
  ///<summary>Turns off one or more lights.</summary>
  public static void TurnOff(this LightEntity target, LightTurnOffParameters data) => target.CallService("turn_off", data);

  ///<summary>Turns off one or more lights.</summary>
  public static void TurnOff(this IEnumerable<LightEntity> target, LightTurnOffParameters data) => target.CallService("turn_off", data);

  ///<summary>Turns off one or more lights.</summary>
  ///<param name="target">The LightEntity to call this service for</param>
  ///<param name="transition">Duration it takes to get to next state.</param>
  ///<param name="flash">If the light should flash.</param>
  public static void TurnOff(this LightEntity target, long? transition = null, object? flash = null) => target.CallService("turn_off", new LightTurnOffParameters { Transition = transition, Flash = flash });

  ///<summary>Turns off one or more lights.</summary>
  ///<param name="target">The IEnumerable<LightEntity> to call this service for</param>
  ///<param name="transition">Duration it takes to get to next state.</param>
  ///<param name="flash">If the light should flash.</param>
  public static void TurnOff(this IEnumerable<LightEntity> target, long? transition = null, object? flash = null) => target.CallService("turn_off", new LightTurnOffParameters { Transition = transition, Flash = flash });

  ///<summary>Turn on one or more lights and adjust properties of the light, even when they are turned on already. </summary>
  public static void TurnOn(this LightEntity target, LightTurnOnParameters data) => target.CallService("turn_on", data);

  ///<summary>Turn on one or more lights and adjust properties of the light, even when they are turned on already. </summary>
  public static void TurnOn(this IEnumerable<LightEntity> target, LightTurnOnParameters data) => target.CallService("turn_on", data);
  ...
  public static void TurnOn(
      ...
      string? profile = null,
      object? flash = null,
      string? effect = null) => target.CallService("turn_on",
        new LightTurnOnParameters {
          Transition = transition, RgbColor = rgbColor, RgbwColor = rgbwColor, RgbwwColor = rgbwwColor,
          ColorName = colorName, HsColor = hsColor, XyColor = xyColor, ColorTemp = colorTemp, Kelvin = kelvin,
          Brightness = brightness, BrightnessPct = brightnessPct, BrightnessStep = brightnessStep,
...
public static class NumberEntityExtensionMethods {
  ///<summary>Set the value of a Number entity.</summary>
  public static void SetValue(this NumberEntity target, NumberSetValueParameters data) => target.CallService("set_value", data);

  ///<summary>Set the value of a Number entity.</summary>
  public static void SetValue(this IEnumerable<NumberEntity> target, NumberSetValueParameters data) => target.CallService("set_value", data);

  ///<summary>Set the value of a Number entity.</summary>
  ///<param name="target">The NumberEntity to call this service for</param>
  ///<param name="value">The target value the entity should be set to. eg: 42</param>
  public static void SetValue(this NumberEntity target, string? value = null) => target.CallService("set_value", new NumberSetValueParameters { Value = value });

  ///<summary>Set the value of a Number entity.</summary>
  ///<param name="target">The IEnumerable<NumberEntity> to call this service for</param>
  ///<param name="value">The target value the entity should be set to. eg: 42</param>
  public static void SetValue(this IEnumerable<NumberEntity> target, string? value = null) => target.CallService("set_value", new NumberSetValueParameters { Value = value });
}

public static class SceneEntityExtensionMethods {
  ///<summary>Activate a scene.</summary>
  public static void TurnOn(this SceneEntity target, SceneTurnOnParameters data) => target.CallService("turn_on", data);

  ///<summary>Activate a scene.</summary>
  public static void TurnOn(this IEnumerable<SceneEntity> target, SceneTurnOnParameters data) => target.CallService("turn_on", data);

  ///<summary>Activate a scene.</summary>
  ///<param name="target">The SceneEntity to call this service for</param>
  ///<param name="transition">Transition duration it takes to bring devices to the state defined in the scene.</param>
  public static void TurnOn(this SceneEntity target, long? transition = null) => target.CallService("turn_on", new SceneTurnOnParameters { Transition = transition });

  ///<summary>Activate a scene.</summary>
  ///<param name="target">The IEnumerable<SceneEntity> to call this service for</param>
  ///<param name="transition">Transition duration it takes to bring devices to the state defined in the scene.</param>
  public static void TurnOn(this IEnumerable<SceneEntity> target, long? transition = null) => target.CallService("turn_on", new SceneTurnOnParameters { Transition = transition });
}

public static class SwitchEntityExtensionMethods {
  ///<summary>Toggles a switch state</summary>
  public static void Toggle(this SwitchEntity target) => target.CallService("toggle");

  ///<summary>Toggles a switch state</summary>
  public static void Toggle(this IEnumerable<SwitchEntity> target) => target.CallService("toggle");

  ///<summary>Turn a switch off</summary>
  public static void TurnOff(this SwitchEntity target) => target.CallService("turn_off");

  ///<summary>Turn a switch off</summary>
  public static void TurnOff(this IEnumerable<SwitchEntity> target) => target.CallService("turn_off");

  ///<summary>Turn a switch on</summary>
  public static void TurnOn(this SwitchEntity target) => target.CallService("turn_on");

  ///<summary>Turn a switch on</summary>
  public static void TurnOn(this IEnumerable<SwitchEntity> target) => target.CallService("turn_on");
}

public static class UpdateEntityExtensionMethods {
  ///<summary>Removes the skipped version marker from an update.</summary>
  public static void ClearSkipped(this UpdateEntity target) => target.CallService("clear_skipped");

  ///<summary>Removes the skipped version marker from an update.</summary>
  public static void ClearSkipped(this IEnumerable<UpdateEntity> target) => target.CallService("clear_skipped");

  ///<summary>Install an update for this device or service</summary>
  public static void Install(this UpdateEntity target, UpdateInstallParameters data) => target.CallService("install", data);

  ///<summary>Install an update for this device or service</summary>
  public static void Install(this IEnumerable<UpdateEntity> target, UpdateInstallParameters data) => target.CallService("install", data);

  ///<summary>Install an update for this device or service</summary>
  ///<param name="target">The UpdateEntity to call this service for</param>
  ///<param name="version">Version to install, if omitted, the latest version will be installed. eg: 1.0.0</param>
  ///<param name="backup">Backup before installing the update, if supported by the integration.</param>
  public static void Install(this UpdateEntity target, string? version = null, bool? backup = null) => target.CallService("install", new UpdateInstallParameters { Version = version, Backup = backup });

  ///<summary>Install an update for this device or service</summary>
  ///<param name="target">The IEnumerable<UpdateEntity> to call this service for</param>
  ///<param name="version">Version to install, if omitted, the latest version will be installed. eg: 1.0.0</param>
  ///<param name="backup">Backup before installing the update, if supported by the integration.</param>
  public static void Install(this IEnumerable<UpdateEntity> target, string? version = null, bool? backup = null) => target.CallService("install", new UpdateInstallParameters { Version = version, Backup = backup });

  ///<summary>Mark currently available update as skipped.</summary>
  public static void Skip(this UpdateEntity target) => target.CallService("skip");

  ///<summary>Mark currently available update as skipped.</summary>
  public static void Skip(this IEnumerable<UpdateEntity> target) => target.CallService("skip");
}
